...
import { Plus, Edit, Trash2, Coffee, Gift as GiftIcon, Utensils } from "lucide-react";
...
export default function Rewards() {
  ...
  const getRewardIcon = (name: string) => {
    ...
    if (lowerName.includes("dinner") || lowerName.includes("food")) return Utensils;
    return GiftIcon;
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {rewards?.length === 0 ? (
          <div className="col-span-full text-center py-12">
            ...
            <p className="text-slate-500">No rewards found. Create your first reward to get started.</p>
          </div>
        ) : (
                ...
                <CardContent className="p-6">
                  ...
                  <div className="space-y-2 mb-4">
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium text-slate-900">{reward.pointThreshold}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-slate-600">Redeemed:</span>
                      <span className="font-medium text-slate-900">
                        {reward.redeemedCount} times
                      </span>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <Badge className={reward.active ? "bg-green-100 text-green-800" : "bg-gray-100 text-gray-800"}>
