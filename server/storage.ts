...
// Force memory storage due to network connectivity issues with Supabase from Replit
let useMemoryStorage = true;
console.log('🔄 Using memory storage (network connectivity issue with Supabase from Replit environment)');
